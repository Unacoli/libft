...
#    Updated: 2021/02/01 16:07:41 by nargouse         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_BONUS = ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstlast.c\
			ft_lstadd_back.c ft_lstdelone.c ft_lstclear.c ft_lstiter.c\
		 	ft_lstmap.c ft_atoi_base_bonus.c ft_check_base_bonus.c\
			ft_convert_base_bonus.c ft_isinbase_bonus.c ft_isspace_bonus.c\
			ft_itoa_base_bonus.c ft_putchar_bonus.c ft_putnbr_base_bonus.c\
			ft_putnbr_bonus.c ft_putstr_bonus.c ft_strchrnul_bonus.c
